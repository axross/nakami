...
| [Product Requirement Guidelines](.claude/skills/product-requirement-guidelines/SKILL.md)                     | Writing, refining, or reviewing a product requirement, feature spec, or issue description, or deciding which plan sections a change needs; the canonical plan-document structure (Summary; Background with goals/non-goals/assumptions; Functional requirements with nested UI design and system design; Non-functional requirements; Acceptance criteria; Verification strategy; Open questions), scope/non-goals framing, testable acceptance criteria, and verification strategy                        |
