...
const styles = StyleSheet.create((theme, rt) => ({
	// The stack header clears the top edge; the bottom and the horizontal pair
	// are this screen's own, and they belong on the scrolled content so the form
	// scrolls under the header rather than stopping short of it.
	content: {
