...
- MUST import the test framework's APIs explicitly if Jest (jest-expo) with React Native Testing Library requires it; this includes setup/teardown hooks, the assertion entrypoint, the test-case function, and the mocking API used in the file.
