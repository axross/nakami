...
Apply these rules to verify the change has the right e2e coverage. The project relies on Maestro e2e tests as the **primary** verification mechanism per the project's development guidelines (verification rules).
