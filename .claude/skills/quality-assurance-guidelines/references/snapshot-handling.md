...
The project's Maestro config typically writes snapshots to a path that includes a **platform-specific** segment, which means snapshots are **OS-specific**. The reviewer MUST be aware:
